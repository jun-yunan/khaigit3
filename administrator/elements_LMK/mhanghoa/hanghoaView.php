...
<div><img class="iconimg" src="./img_LMK/anhquanly.png" alt="">Quản lý hàng hoá</div>
<hr>
<div class="title_mod"><img src="./img_LMK/themoi.png" alt="" class="iconimg">Thêm hàng hoá</div>
<div class="content_mod">
    <form name="newhanghoa" id="formadd_hanghoa" method="post" enctype="multipart/form-data" action="./elements_LMK/mhanghoa/hanghoaAct.php?reqact=addnew">
        <table>
            <tr>
                <td>Tên loại hàng</td>
...
<div class="title_mod"><img class="iconimg" src="./img_LMK/list.png" alt="">Danh sách hàng hoá</div>
<div class="content_mod">
    <?php
    require './elements_LMK/mod/hanghoaCls.php';
        ...
        <table border="1">
            <thead>
                <tr>
                    <th>id</th>
                    <th>Tên hàng hoá</th>
                    <th><img src="./img_LMK/hinhanh.png" alt="" class="iconimg"></th>
                    <th><img src="./img_LMK/hinhanh.png" alt="" class="iconimg"></th>
                    <th><img src="./img_LMK/hinhanh.png" alt="" class="iconimg"></th>
                    <th><img src="./img_LMK/tool.png" alt="" class="iconimg"></th>
                </tr>
            </thead>
            <tbody>
                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if (isset($_SESSION['ADMIN'])) {
                                ?>
                                <a href="./elements_LMK/mhanghoa/hanghoaAct.php?reqact=deletehanghoa&idhanghoa=<?php echo $v->idhanghoa;?>">
                                    <img src="./img_LMK/anhxoa.png" alt="" class="iconimg">
                                </a>
                                <?php
                            }
                            else {
                            ...
                            <a href="index.php?req=hanghoaUpdate&idhanghoa=<?php echo $v->idhanghoa; ?>">
                                <img src="./img_LMK/khoiphuc.png" alt="" class="iconimg">
                            </a>
                        </td>
                    </tr>
                <?php
